...
abstract class Base_Carousel extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'label' => esc_html__('Effect', 'topscore-extra'),
                'default' => 'slide',
                'options' => [
                    'slide' => esc_html__('Slide', 'topscore-extra'),
                    'fade' => esc_html__('Fade', 'topscore-extra'),
                    'cube' => esc_html__('Cube', 'topscore-extra'),
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                'type' => Controls_Manager::SLIDER,
                'label' => esc_html__('Width', 'topscore-extra'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Additional Options', 'topscore-extra'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'yes',
                'label_off' => esc_html__('Hide', 'topscore-extra'),
                'label_on' => esc_html__('Show', 'topscore-extra'),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'bullets' => esc_html__('Dots', 'topscore-extra'),
                    'fraction' => esc_html__('Fraction', 'topscore-extra'),
                    'progressbar' => esc_html__('Progress', 'topscore-extra'),
                ],
        ...
        $this->add_control(
            'lazyload',
            [
                'label' => esc_html__('Lazyload', 'topscore-extra'),
                'type' => Controls_Manager::SWITCHER,
                'separator' => 'before',
                'frontend_available' => true,
            ]
                ...
                <?php if (1 < $slides_count) : ?>
                    ...
                    <?php if ($settings['show_arrows']) : ?>
                        <div class="elementor-swiper-button elementor-swiper-button-prev" role="button" tabindex="0">
                            ...
                            <span class="elementor-screen-only"><?php echo esc_html__('Previous', 'topscore-extra'); ?></span>
                        </div>
                        <div class="elementor-swiper-button elementor-swiper-button-next" role="button" tabindex="0">
                            <?php $this->render_swiper_button('next'); ?>
                            <span class="elementor-screen-only"><?php echo esc_html__('Next', 'topscore-extra'); ?></span>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
