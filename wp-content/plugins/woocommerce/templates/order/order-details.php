...
<style>
.button.button-primary.wt_pklist_invoice_print, .button.button-primary.wt_pklist_invoice_download, .order-again a{
...
.button.button-primary.wt_pklist_invoice_print:hover, .button.button-primary.wt_pklist_invoice_download:hover, .order-again a:hover{
...
.woocommerce-table.woocommerce-table--order-details.shop_table.order_details br {
